<%@ Page Language="C#" MasterPageFile="~/Template/Administrator/MasterPage.master" AutoEventWireup="true" CodeFile="ListBusAdd.aspx.cs" Inherits="Administrator_ListBusAdd" Title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>List Bus Add</title>
...
<!-- breadcrumb -->
	...
	<!-- /breadcrumb -->
		...
		<div class="right"></div>
		<div class="heading">
			<h1 style="background-image:url(Image/review.png);">List Bus [New]</h1>
			<div class="buttons">
