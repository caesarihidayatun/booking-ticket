<%@ Page Language="C#" MasterPageFile="~/Template/Administrator/MasterPage.master" AutoEventWireup="true" CodeFile="BusEdit.aspx.cs" Inherits="Administrator_BusEdit" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="box">
		...
		<div class="right"></div>
		<div class="heading">
			<h1 style="background-image:url(Image/review.png);">Bus: [Edit]</h1>
			<div class="buttons">
                <asp:LinkButton ID="lnkBtnUpdate" runat="server" CssClass="button" 
                    onclick="lnkBtnUpdate_Click"><span>Update</span></asp:LinkButton>
		    ...
		    <table class="form">
        		<tbody>
	            	<tr>
	              		...
	              		<td><asp:TextBox ID="BusPlate" runat="server" Width="125px" Enabled="False"></asp:TextBox>
	              		</td>
	            	</tr>
	            	<tr>
	              		<td>Bus Name: </td>
