...
namespace DAL
{
    public class DALRouter : DALBase, IDALRouter
    {
        ...
        public int InsertRouter(Router router) {
            ...
            try
            {
                String[] columns = {routerName, startPlace, destinationPlace, distance, description, createDate, status};
                Object[] values = {router.RouterName, router.StartPlace, router.DestinationPlace, router.Distance, router.Description, router.CreateDate, router.Status};
        ...
        public int UpdateRouter(Router router)
        {
            ...
            try
            {
                String[] columnNames = { routerName, startPlace, destinationPlace, distance, description, createDate, status };
                Object[] values = { router.RouterName, router.StartPlace, router.DestinationPlace, router.Distance, router.Description, router.CreateDate, router.Status };
                String[] keyColumnNames = {routerId};
        ...
        public Router[] getRouterByID(int id)
        {
            ...
            try
            {
                ...
                String[] columnNames = { routerId, routerName, startPlace, destinationPlace, distance, description, createDate, status };
