<%@ Page Language="C#" MasterPageFile="~/Template/Administrator/MasterPage.master" AutoEventWireup="true" CodeFile="CancelChargeAdd.aspx.cs" Inherits="Administrator_CancelChargeAdd" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="box">
		...
		<div class="right"></div>
		<div class="heading">
			<h1 style="background-image:url(Image/review.png);">Cancel Charge: [New]</h1>
			<div class="buttons">
