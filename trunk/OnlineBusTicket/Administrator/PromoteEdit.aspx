<%@ Page Language="C#" MasterPageFile="~/Template/Administrator/MasterPage.master" AutoEventWireup="true" CodeFile="PromoteEdit.aspx.cs" Inherits="Administrator_PromoteEdit" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="box">
		...
		<div class="right"></div>
		<div class="heading">
			<h1 style="background-image:url(Image/review.png);">Promote: [Edit]</h1>
			<div class="buttons">
